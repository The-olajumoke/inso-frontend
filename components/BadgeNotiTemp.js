...
const BadgeNotiTemp = () => {
  return (
    <>
      ...
      <div className="bg-white-white h-auto w-full hidden vp-600:flex flex-col rounded-xs shadow-xs px-12 items-center mb-28 py-18 justify-between">
        ...
        <div className=" border-l-2 border-green-lightGreen flex items-center justify-center vp-600:border-none">
          <div className=" w-203 vp-600:w-210 bg-blue-inputBlue h-34 rounded px-14 flex items-center justify-center">
            <p className="ml-14">
              <span className=" text-primary-darkGreen font-medium mr-2">
                {" "}
                4{""}{" "}
              </span>
              {}
