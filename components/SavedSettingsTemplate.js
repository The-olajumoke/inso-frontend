...
const SavedSettingsTemplate = ({ setViewInspirations }) => {
  ...
  return (
    <div className="h-full flex flex-col flex-grow">
      ...
      <div className="flex px-45 items-center my-17 justify-between">
        <h5>Score setting 1</h5>
        <h5 className=" text-primary-blue">Save</h5>
      </div>
      <div className=" bg-gray-createDisc pt-20 px-45 flex flex-col flex-grow">
        ...
        {activeSetting === "Automatic" && (
          <div className="bg-gray-createDisc flex flex-col justify-between  flex-grow">
            <div className=" ">
              <div
                className={` ${
              ...
              >
                <div className="flex justify-between items-center">
                  <div className="flex items-center text-xl">
                    <CheckBox />
                    <h5 className="ml-20 text-black-analText">Instructions</h5>
                  </div>
              ...
              <div className="h-30 flex items-center w-full  text-black-analText justify-between mb-24">
                <div className="flex items-center text-xl">
                  <CheckBox />
              ...
              <div className="h-30 flex items-center w-full  text-black-analText justify-between  mb-33">
                <div className="flex items-center text-xl">
                  <CheckBox />
              ...
              <div className="h-30 flex items-center w-full  text-black-analText justify-between  pb-27">
                <div className="flex items-center text-xl">
...
export default SavedSettingsTemplate;
