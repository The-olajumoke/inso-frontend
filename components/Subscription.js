...
const Subscription = () => {
  return (
    <div className="h-900 bg-primary-darkGreen relative overflow-hidden ">
      ...
      <div className="bg-transparent absolute top-0 bottom-0 -right-0 left-0 pt-62 pb-120 px-63 vp-1024:px-46 vp-600:px-20 ">
        <h2 className="text-white-white font-medium mb-66 text-center ">
          Subscription plans
        </h2>{" "}
        <div className="border vp-600:w-400 overflow-auto">
          <div
