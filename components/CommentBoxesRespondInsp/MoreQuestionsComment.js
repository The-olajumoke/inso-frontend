...
const MoreQuestionsComment = ({ setActiveCommentBox, togglePostInsp }) => {
        ...
        {currentSection === "Clarify" && (
          <div className="h-200 bg-white-white ">
            <Editor
              ...
              toolbar={toolbar}
              mention={mention}
              placeholder="Ask at least three follow-up questions to help focus on important concepts and possible explanations."
            />
          </div>
        )}
        {currentSection === "Support" && (
...
export default MoreQuestionsComment;
